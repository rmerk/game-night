...
<template>
  <TransitionGroup name="reaction-fade" tag="div" class="flex flex-col-reverse items-center gap-1">
...
@media (prefers-reduced-motion: reduce) {
  .reaction-fade-enter-active,
  .reaction-fade-leave-active {
    transition: opacity var(--timing-tactile, 120ms) var(--ease-tactile, ease-out);
  }
